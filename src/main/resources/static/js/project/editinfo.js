$(document).ready(function() {
    ...
    $("#tab2").on("input", "tr td:nth-child(8) input", function(event) {
        ...
        if ($(this).val() == "" || reg.test($(this).val()))
            ...
            $(this).css("background-color", "#f00");
        var color = $(this).parents("tr").find("td:eq(9) input").css("background-color");
        if (color != null && color == "rgb(255, 255, 255)")
    ...
    $("#tab2").on("input", "tr td:nth-child(9) input", function(event) {
        ...
        if ($(this).val() == "" || reg.test($(this).val()))
            ...
            $(this).css("background-color", "#f00");
        var color = $(this).parents("tr").find("td:eq(7) input").css("background-color");
